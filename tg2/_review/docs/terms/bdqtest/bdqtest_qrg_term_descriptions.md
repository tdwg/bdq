...
| has Use Cases (bdqffdq:hasUseCase) | non-normative | Relates a bdqffdq:Policy to a bdqffdq:UseCase. In present context: One or more Use Cases which this Test is linked to through a Policy. | bdqval:Spatial-Temporal_Patterns, bdqval:Record-Management |
