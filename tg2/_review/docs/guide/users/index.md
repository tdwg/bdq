...
- [2.1 Kinds of Tests and what they do (non-normative)](#21-kinds-of-tests-and-what-they-do-(non-normative))
- [2.2 Test inputs and outputs](#22-test-inputs-and-outputs)
- [2.2.1 Inputs to a test (non-normative)](#221-inputs-to-a-test-(non-normative))
- [2.2.2 Parts of a Response from a test. (normative)](#222-parts-of-a-response-from-a-test-(normative)-)
- [2.2.3 Responses from different kinds of test. (normative)](#223-responses-from-different-kinds-of-test-(normative)-)
