...
- [2 Test inputs and outputs](#2-test-inputs-and-outputs)
- [2.1 Inputs to a test (non-normative)](#21-inputs-to-a-test-(non-normative))
- [2.2 Parts of a Response from a test. (normative)](#22-parts-of-a-response-from-a-test-(normative)-)
- [2.3 Responses from different kinds of test. (normative)](#23-responses-from-different-kinds-of-test-(normative)-)
- [2.4 Amendments only propose changes (normative)](#24-amendments-only-propose-changes-(normative))
- [2.5 Test Parameters. (normative)](#25-test-parameters-(normative)-)
- [3 Reading the Quick Reference Guide to the tests (non-normative)](#3-reading-the-quick-reference-guide-to-the-tests-(non-normative))
- [4 Time and TimeZone (non-normative)](#4-time-and-timezone-(non-normative))
...
## 2.1 Inputs to a test (non-normative)
...
## 2.2 Parts of a Response from a test. (normative) 
...
## 2.3 Responses from different kinds of test. (normative) 
...
# 2.4 Amendments only propose changes (normative)
