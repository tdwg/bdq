...
Data do not have quality in the abstract; they only have quality with respect to a particular use. The Fitness For Use [Framework](</home/mole/git/bdq/tg2/_review/index.md#framework> "The Fitness for Use Framework, the body of work that provides a fundamental structure for the [BDQ](</home/mole/git/bdq/tg2/_review/index.md#bdq> "Biodiversity Data Quality Standard. This document.") Tests. The Fitness for Use Framework is derived from (Veiga 2016) and is the outcome of the [TDWG](</home/mole/git/bdq/tg2/_review/index.md#tdwg> "[Biodiversity Information Standards](https://www.tdwg.org/standards/sds/)") Data Quality Task Group…") (see [Fitness For Use Framework Ontology Guide](../bdqffdq/index.md)) in the BDQ standard describes uses for data as `Use Cases`.
...
We use a shorthand to describe a collection of formal Fitness For Use Framework concepts: an instance of a subtype of `bdqffdq:Response` [bdqffdq:Response](</home/mole/git/bdq/tg2/_review/docs/list/bdqffdq/index.md#response> "A bdqffdq:ReportConcept produced by a bdqffdq:Implementation expressing a statement about data quality resulting from the application of the logic of a bdqffdq:Specification to a bdqffdq:DataResource.") produced by running a Test, which carries a response status, result, comment and optional qualifier via the `bdqffdq:hasResponseStatus` [bdqffdq:hasResponseStatus](</home/mole/git/bdq/tg2/_review/docs/list/bdqffdq/index.md#hasresponsestatus> "The bdqffdq:ResponseStatus object asserted by a bdqffdq:Response."), `bdqffdq:hasResponseResult` [bdqffdq:hasResponseResult](</home/mole/git/bdq/tg2/_review/docs/list/bdqffdq/index.md#hasresponseresult> "The bdqffdq:ResponseResult object asserted by a bdqffdq:Response.")/`bdqffdq:hasResponseResultValue` [bdqffdq:hasResponseResultValue](</home/mole/git/bdq/tg2/_review/docs/list/bdqffdq/index.md#hasresponseresultvalue> "Data property carrying the value of a bdqffdq:Response when the value is not an object."), `bdqffdq:hasResponseComment` [bdqffdq:hasResponseComment](</home/mole/git/bdq/tg2/_review/docs/list/bdqffdq/index.md#hasresponsecomment> "Free text describing the bdqffdq:Response made in the response and why that conclusion was reached."), and `bdqffdq:hasResponseQualifier` [bdqffdq:hasResponseQualifier](</home/mole/git/bdq/tg2/_review/docs/list/bdqffdq/index.md#hasresponsequalifier> "ResponseQualifier object asserted by an Response.") properties.
...
The content of [Response.comment](</home/mole/git/bdq/tg2/_review/index.md#response-comment> "A human readable interpretation of the results of a Test. A shortcut for `bdqffdq:hasResponseComment") is not defined by the BDQ standard and may vary, so phrasing such as "There was no day 30 in February of 1952" is also acceptable.
...
`Measures` may be: 
- `Single Record` `Measures` that directly measure an `Information Element` value and return a metric (e.g., MEASURE_EVENTDATE_DURATIONINSECONDS), or that count the results of other Tests on the same `Single Record` (e.g., MEASURE_AMENDMENTS_PROPOSED).
...
For example, a user working with data from just one country may wish to change a default `bdqval:sourceAuthority` [bdqval:sourceAuthority](</home/mole/git/bdq/tg2/_review/docs/list/bdqval/index.md#sourceauthority> "An authority using the 'bdqval' namespace that provides a reference for values required for a Test evaluation. Where the Test is a bdqval:ParameterizedTest a bdqval:defaultSourceAuthority ('bdqval:sourceAuthority defaul…") for some Test to an authority that is more appropriate for that particular country – e.g. to change the default species names authority (which covers the whole world) to one specific for just that country, all while retaining the same decision making process within the Test. For more details see [Parameterizing the Tests](../../guide/bdqtest/index.md#43-parameterizing-the-tests-normative) in the [BDQ Tests: Concepts and Use](../../guide/bdqtest/index.md) document.
...
* **Versioned [IRI](</home/mole/git/bdq/tg2/_review/index.md#iri> "Internationalized Resource Identifier is an internet protocol standard which builds on the Uniform Resource Identifier (URI) protocol by greatly expanding the set of permitted characters."):** - the means for software to identify the Test (e.g. https://rs.tdwg.org/bdqtest/terms/version/ac2b7648-d5f9-48ca-9b07-8ad5879a2536-2023-09-17)). The Versioned IRI is the definitive identifier for a particular version of a Test and is intended for use by software.
