...
- In Quality Assurance ([QA](<../../../index.md#glossary_QA> "[bdqffdq:QualityAssurance](https://../_review/docs/list/bdqffdq/index.md#qualityassurance). The process of evaluating data for fitness for some use and selecting just those data that are fit for that use. See also [User…")), data are evaluated for fitness for use and are filtered down to just those data that are fit for that use.
