...
```
Note that in RDF representations, the `Response` is an instance of `bdqffdq:Response` [bdqffdq:Response](<../../list/bdqffdq/index.md#Response> "A bdqffdq:ReportConcept produced by a bdqffdq:Implementation expressing a statement about data quality resulting from the application of the logic of a bdqffdq:Specification to a bdqffdq:DataResource."), and the `Response.status` is a value of `bdqffdq:hasResponseStatus` [bdqffdq:hasResponseStatus](<../../list/bdqffdq/index.md#hasResponseStatus> "The bdqffdq:ResponseStatus object asserted by a bdqffdq:Response."), while the `Response.result` may be either a literal using `bdqffdq:hasResponseResultValue` [bdqffdq:hasResponseResultValue](<../../list/bdqffdq/index.md#hasResponseResultValue> "Data property carrying the value of a bdqffdq:Response when the value is not an object.") or a Named Individual using bdqffdq:hasResponseResult, or, as a best practice with RDF, when null, is ommitted, and the `Response.comment` is a value of `bdqffdq:hasResponseComment` [bdqffdq:hasResponseComment](<../../list/bdqffdq/index.md#hasResponseComment> "Free text describing the bdqffdq:Response made in the response and why that conclusion was reached.").
...
Implementers SHOULD create an instance of `bdqffdq:Mechanism` [bdqffdq:Mechanism](<../../list/bdqffdq/index.md#Mechanism> "An entity that can execute bdqffdq:DataQualityMethods.") to uniquely identify their suite of Test implementations.

Implementations producing `Data Quality Reports` SHOULD create instances of `bdqffdq:Responses` grouped in `bdqffdq:DataQualityReports` that also specify the `bdqffdq:DataResource` [bdqffdq:DataResource](<../../list/bdqffdq/index.md#DataResource> "An owl:Thing to which a data quality bdqffdq:Response applies.") that the `bdqffdq:DataQualityReport` [bdqffdq:DataQualityReport](<../../list/bdqffdq/index.md#DataQualityReport> "A bdqffdq:ReportConcept comprising a set of data quality bdqffdq:Responses.") concerns.
...
1. **Confirm the required inputs**
   ...
   - Identify any `Parameters` and their default value (from `bdqffdq:hasAuthoritiesDefaults` and/or `bdqffdq:hasArgument` [bdqffdq:hasArgument](<../../list/bdqffdq/index.md#hasArgument> "Relates a bdqffdq:Specification to a bdqffdq:Argument") / `bdqffdq:Argument` [bdqffdq:Argument](<../../list/bdqffdq/index.md#Argument> "A value that, when provided to a Test bdqffdq:Specification to replace a bdqffdq:Parameter changes the behavior of the Test in a defined manner.")).
...
* The `Implementation` is related to the `Response` it generated using `bdqffdq:producesResponse` [bdqffdq:producesResponse](<../../list/bdqffdq/index.md#producesResponse> "Connects an entity with a bdqffdq:Response that the entity created."), is related to the `Specification` it ran using `bdqffdq:usesSpecification` [bdqffdq:usesSpecification](<../../list/bdqffdq/index.md#usesSpecification> "The bdqffdq:Specification that a bdqffdq:Implementation implements."), and is related to the `Mechanism` that executed it using `bdqffdq:implementedBy` [bdqffdq:implementedBy](<../../list/bdqffdq/index.md#implementedBy> "The bdqffdq:Mechanism that provides a bdqffdq:Implementation").
