...
- [1.1 Characteristics of the tests (non-normative)](#11-characteristics-of-the-tests-(non-normative))
- [1.2 Structure of Response (normative)](#12-structure-of-response-(normative))
- [1.3 Resource Types (normative)](#13-resource-types-(normative))
...
- [1.4 Test Descriptors](#14-test-descriptors)
- [1.5 Parameterising the tests](#15-parameterising-the-tests)
- [1.6 Example RDF (non-normative)](#16-example-rdf-(non-normative)-)
- [1.7 Status of the content of this document](#17-status-of-the-content-of-this-document)
- [1.8 Term List Distributions for bdqcore:](#18-term-list-distributions-for-bdqcore)
- [1.9 Namespace abbreviations](#19-namespace-abbreviations)
