...
**Abstract**: **Identifing Synthetic and Modified Data** is a standard for the marking of synthetic and modified biodiversity data to allow users of biodiversity data to identify and exclude modified and synthetic data from analysies and other uses.
...
BDQ Core Maintenance Group. 2024. Biodiversity Data Quality (BDQ) Core Identifying Synthetic and Modified Data. Biodiversity Information Standards (TDWG). http://rs.tdwg.org/bdq/doc/synthetics/2024-08-31
