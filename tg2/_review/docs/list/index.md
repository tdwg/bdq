**NOTE** This is just a placeholder for the BDQ Core Tests and Assertions term list document, which will be generated by code.

# BDQ Core Tests and Assertions List of Terms

**Title**: BDQ Core Tests and Assertions List of Terms
