...
| Developed As Github Issue (skos:historyNote) |  | A note about the past state/use/meaning of a concept. In present context: A link to the github issue that provided rationalle management recording a history (changes and comments) of the development of the test. | [https://api.github.com/repos/tdwg/bdq/issues/ 32](https://api.github.com/repos/tdwg/bdq/issues/32) |
