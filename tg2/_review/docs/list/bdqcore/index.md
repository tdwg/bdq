...
| Method label (rdfs:label) | non-normative | A human-readable name for the subject. In present context: The label for the instance of the subclass of bdqffdq:Method for this test. |  |
...
| Specification label (rdfs:label) | non-normative | A human-readable name for the subject. In present context: The label for the instance of the bdqffdq:Specification for this test |  |
| Type (rdf:type) | normative | The subject is an instance of a class. In present context: The type of the test, one of the subtypes of bdqffdq:DataQualityNeed. | Amendment |
...
| Developed As Github Issue (skos:historyNote) | non-normative | A note about the past state/use/meaning of a concept. In present context: A link to the github issue that provided rationalle management recording a history (changes and comments) of the development of the test. | [https://api.github.com/repos/tdwg/bdq/issues/ 32](https://api.github.com/repos/tdwg/bdq/issues/32) |
