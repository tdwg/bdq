...
The combination of `Information Element` and Evaluation was called the [Term-Action](<../../index.md#glossary_TermAction> "The last two components of the Label in the BDQ GitHub. Test descriptors, useful in filtering Tests in CSV files. Example: 'COUNTRYCODE_STANDARD'") in the GitHub issues used to develop the tests.  This combination was found useful for sorting and classifying Tests.
...
[TDWG](<../../index.md#glossary_TDWG> "Biodiversity Information Standards") Biodiversity Data Quality Interest Group Task Group 2: Data Quality Tests and Assertions. 2026. BDQ Supplemental Information. Biodiversity Information Standards (TDWG). <https://bdq.tdwg.org/vocabularies/2026-06-03>
