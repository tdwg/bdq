...
Given a `Specification` (as would be known when starting with a `bdqffdq:Response` [bdqffdq:Response](<../list/bdqffdq/index.md#Response> "A bdqffdq:ReportConcept produced by a bdqffdq:Implementation expressing a statement about data quality resulting from the application of the logic of a bdqffdq:Specification to a bdqffdq:DataResource.") and following `bdqffdq:producesResponse` [bdqffdq:producesResponse](<../list/bdqffdq/index.md#producesResponse> "Connects an entity with a bdqffdq:Response that the entity created.") to a `bdqffdq:Implementation` [bdqffdq:Implementation](<../list/bdqffdq/index.md#Implementation> "A bdqffdq:SolutionsConcept that describes the portion of a bdqffdq:Mechanism that carries out the proccess described in a particular bdqffdq:Specification.") then `bdqffdq:usesSpecification` [bdqffdq:usesSpecification](<../list/bdqffdq/index.md#usesSpecification> "The bdqffdq:Specification that a bdqffdq:Implementation implements.")), which Test was run with which argument values for which `Parameters`?
...
Tests are identified by the `bdqffdq:` namespace classes of `Validation`, `Issue`, `Measure`, and `Amendment`. Each of these types of Tests can be composed with a ResourceType to apply to a single record (`bdqffdq:SingleRecord` [bdqffdq:SingleRecord](<../list/bdqffdq/index.md#SingleRecord> "A single entity comprised of encoded data with a defined structure that contains one instance of a core concept from the perspective of bdqffdq:InformationElements assessed for a bdqffdq:DataQualityNeed.")), or to multiple records comprising a dataset (`bdqffdq:MultiRecord` [bdqffdq:MultiRecord](<../list/bdqffdq/index.md#MultiRecord> "A set of one or more bdqffdq:SingleRecords.")). In the BDQ standard, we have described a set of `Single Record` `Validations`, `Issues`, `Measures`, and `Amendments` plus a set of `Multi Record` `Measures`. The formal statement of each of these is complex, being a composition of an instance of a subclass of a `bdqffdq:DataQualityNeed` [bdqffdq:DataQualityNeed](<../list/bdqffdq/index.md#DataQualityNeed> "A bdqffdq:NeedConcept that expresses what bdqffdq:Responses may be made about data with respect to fitness for use.") with an instance of a subclass of a `bdqffdq:Method` with an instance of a `bdqffdq:Specification` [bdqffdq:Specification](<../list/bdqffdq/index.md#Specification> "A specific statement about how to evaluate a bdqffdq:DataQualityNeed."), but we subsume this complexity with the phrases "Validation Test", "Issue Test", "Measure Test", and "Amendment Test".
...
* Class terms in `bdqffdq:` are nouns in UpperCamelCase and have a label that separates the words.
  * Example: `bdqffdq:AmendmentConcept` [bdqffdq:AmendmentConcept](<../list/bdqffdq/index.md#AmendmentConcept> "A term involved in proposals of changes to data or process to improve data quality to fit an expressed bdqffdq:DataQualityNeed.") with its `rdfs:label` "Amendment Concept".
...
* Object property terms and Datatype property terms in `bdqffdq:` are verbs in lowerCamelCase, and have a label that separates out words, and preserves the case.
  * Example `bdqffdq:composedOf` [bdqffdq:composedOf](<../list/bdqffdq/index.md#composedOf> "Specific vocabulary term that comprises a bdqffdq:InformationElement that is not a bdqffdq:AbstractInformationElement.") with its `rdfs:label` "composed Of".
...
* Most `bdqffdq:` Named Individuals have names and matching labels in all upper case characters.
  * Example: `bdqffdq:AMENDED` [bdqffdq:AMENDED](<../list/bdqffdq/index.md#AMENDED> "A bdqffdq:ResponseStatus used to indicate that a bdqffdq:hasResponseResultValue from a bdqffdq:Amendment contains a proposed change.") with its `rdfs:label` "AMENDED"
