...
| Framework | The Fittness for Use Framework, the body of work that provides a fundamental structure for the BDQ Core Tests.  The Fittness for Use Framework is derived from (Viega 2016) and is the outcome of the TDWG Data Quality Task Group 1: Framework on Data Quality (Veiga et al. 2017). | bdqffdq: |
| Framework Ontology | A model of the Framework (Viega 2016, Viega et al, 2017) as an owl ontology, present as the bdqffdq: vocabulary in BDQ Core. | bdqffdq: |
