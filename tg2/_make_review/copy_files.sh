...
./test-util.sh -config data/tg2_tests.properties -format RDFXML -out ../bdq/tg2/_review/dist/bdqtest.xml -in  data/TG2_tests.csv -guidFile ../bdq/tg2/core/TG2_tests_additional_guids.csv -ieGuidFile ../bdq/tg2/core/information_element_guids.csv -policyGuidFile ../bdq/tg2/core/TG2_policy_guids.csv -suggestPolicyGuidUpdates -makeGuidList 
./test-util.sh -config data/tg2_tests.properties -format TURTLE -out ../bdq/tg2/_review/dist/bdqtest.ttl -in  data/TG2_tests.csv -guidFile ../bdq/tg2/core/TG2_tests_additional_guids.csv -ieGuidFile ../bdq/tg2/core/information_element_guids.csv -policyGuidFile ../bdq/tg2/core/TG2_policy_guids.csv 
./test-util.sh -config data/tg2_tests.properties -format JSON-LD -out ../bdq/tg2/_review/dist/bdqtest.json -in  data/TG2_tests.csv -guidFile ../bdq/tg2/core/TG2_tests_additional_guids.csv -ieGuidFile ../bdq/tg2/core/information_element_guids.csv -policyGuidFile ../bdq/tg2/core/TG2_policy_guids.csv
