...
OUTPUT_PATH = '../_review/docs/terms/bdqtest/bdq_qrg.html'
    ...
    <main>
        <h1 id="top">BDQ Tests Quick Reference Guide</h1>
            <div class="intro">
              ...
              <p>This document is intended to be an easy-to-read reference for the Tests maintained as part of the TDWG standard <a href="http://example.org/to_be_determined">BDQ</a> produced by the TDWG Biodiversity Data Quality Interest Group Task Group 2: Data Quality Tests and Assertions and is maintained by the BDQ Maintenance Interest Group. This document lists the BDQ Tests, described by the <a href="bdqtest_qrg_term_descriptions.md">Terms Used in the BDQ Tests Quick Reference Guide</a>. Definitions, comments, and examples may include namespace abbreviations (e.g., <code>bdq:</code>, <code>dwc:</code>). These are required as the meaning for the word is defined specifically in that namespace. Thus, <code>dwc:Event</code> means Event as defined by Darwin Core at <a href="https://dwc.tdwg.org/terms/#event">https://dwc.tdwg.org/terms/#event</a>.</p>
              <p>This page is a descriptive document, not the full vocabulary definition document for <code>bdqtest:</code> terms. It combines the normative Test names and terms with non-normative comments and examples that are meant to help people to use the Tests consistently. Further details can be found in <a href="../../../index.md">The Biodiversity Data Quality (BDQ) Standard</a>, the <a href="../../guide/bdqffdq/index.md">Fitness For Use Framework Ontology Guide</a>, and the <a href="../../guide/implementers/index.md">BDQ Implementer's Guide</a>.</p>
