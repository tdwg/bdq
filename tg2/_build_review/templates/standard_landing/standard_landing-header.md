...
| <a name="glossary_QA"/>QA | bdqffdq:QualityAssurance.  The process of evaluating data for fitness for some use and selecting just those data that are fit for that use. See also [User's Guide #2.1](docs/guide/users/index.md#21-quality-control-and-quality-assurance-non-normative).| Data Quality |
| <a name="glossary_QC"/>QC | bdqffdq:Quality Control.The process of identifying data that are not fit for particular uses, with the goal of improving the data quality. The tests may propose changes to improve the quality of the data.  See also [User's Guide #2.1](docs/guide/users/index.md#21-quality-control-and-quality-assurance-non-normative). | Data Quality |
