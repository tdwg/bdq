# Produce a CSV file with only the most recent version of each term_iri from bdqtest_term_versions.csv

import pandas as pd
import csv

input_csv = '../vocabulary/bdqtest_term_versions.csv'
output_csv = '../dist/bdqtest_singlerecord_tests_current.csv'
