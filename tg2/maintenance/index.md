...
Readers should be familiar with the structure of the BDQ standard and its supporting tools and vocabularies.
...
However, additional background information and development context for BDQ may be found in the [BDQ Supplemental Information](../_review/docs/supplement/index.md).
...
<!--- TODO: These templates should get moved to a new maintenance repository for BDQ and should be removed from tdq/bdq --->
...
- Ancillary information that provides a context for generating and maintaining Test Validation Data
  ...
  - Data Dimension: What dimension of the data (what general category of Information Element) does the Test focus on, either NAME, SPACE, TIME, or OTHER (for definitions - see the [Glossary](../_review/index.md#6-glossary-non-normative) in [The Biodiversity Data Quality (BDQ) Standard](../_review/index.md)).
